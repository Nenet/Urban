...
/**
 * Fonction de rendu qui retourne le code HTML
 * servant à afficher un select d'après deux paramètres
 * 
 * @param array $liste Tableau à 2 colonnes
 * @param string $colValue Identifiant passé à l'attribut value
 * @param string $name Valeur name="..." du select
 * 
 * <p>Exemple de sortie:</p>
 * <p>&lt;select name="idPays"&gt;<br>
 * 		&lt;option value="1"&gt;Suisse ch&lt;/option&gt;<br>
 * 		...<br>
 * 		&lt;option value="7"&gt;Lichtenstein li&lt;/option&gt;<br>
 * &lt;/select&gt;</p>
 * 
 */
